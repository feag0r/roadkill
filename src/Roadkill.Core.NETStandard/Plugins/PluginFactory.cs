...
namespace Roadkill.Core.Plugins
{
	...
	public class PluginFactory : IPluginFactory
	{
		...
		{
			return _container.GetAllInstances<TextPlugin>().FirstOrDefault(x => x.Id.Equals(id, StringComparison.CurrentCultureIgnoreCase));
		}
		...
		{
			return _container.GetAllInstances<SpecialPagePlugin>().FirstOrDefault(x => x.Name.Equals(name, StringComparison.CurrentCultureIgnoreCase));
		}
	}
}