...
namespace Roadkill.Tests
{
	public class TestConstants
	{
		...
		public static readonly string SQLSERVER_CONNECTION_STRING = "Server=.\\SQLEXPRESS;Integrated Security=true;Connect Timeout=5;Database=roadkill";
		...
		static TestConstants()
		{
			...
			else
			{
				...
				SQLSERVER_CONNECTION_STRING = "Server=.\\SQLEXPRESS;Integrated Security=true;Connect Timeout=5;Database=roadkill";
			}
		}
	}
}